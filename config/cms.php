...
return [
    ...
    'field_labels' => [
        ...
        'services.hero.banner_image' => 'Hero — main image or video',
        'services.hero.banner_alt' => 'Hero media — alt text',
        ...
        'our-fleet.hero.banner_image' => 'Hero — main image or video',
        'our-fleet.hero.banner_alt' => 'Hero media — alt text',
        ...
        'home.services_industries.button_text' => 'Services (#industries-scroll) — left column CTA button label',
        'home.services_industries.button_link' => 'Services (#industries-scroll) — left column CTA link (path or URL)',
    ...
    'section_labels' => [
        ...
        'services_industries' => 'Services (#industries-scroll — heading, intro, CTA; service cards in repeater below)',
