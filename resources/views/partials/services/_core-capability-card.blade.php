            ...
            <div class="ssr-variant">
                <div class="framer-poamg-container">
                    <div class="framer-rOBNv framer-LQZ0A framer-1rtee3t framer-v-1rtee3t" data-framer-name="tag" style="opacity: 1;">
                        <div class="framer-1jru3ku" data-border="true" data-framer-appear-id="1jru3ku" data-framer-name="shape" style="--border-bottom-width: 4px; --border-color: var(--token-0cfc16fd-3729-4b64-9ac8-d1037c8fcb3d, rgb(249, 64, 6)); --border-left-width: 4px; --border-right-width: 4px; --border-style: solid; --border-top-width: 4px; border-radius: 56px; opacity: 1; transform: none"></div>
                ...
                <div class="ssr-variant">
                    <div class="framer-l71w6v-container" data-framer-name="img - service" name="img - service">
                        <div name="img - service" class="framer-Z0z4Z framer-rlntoc framer-v-ut5ihd" data-framer-name="image - start" style="max-height: 100%; width: 100%; border-radius: 8px; opacity: 1;">
                            <div class="framer-1nbhg90" data-framer-name="frame" style="background-color: var(--token-0cfc16fd-3729-4b64-9ac8-d1037c8fcb3d, rgb(249, 64, 6)); opacity: 1;"></div>
