...
<style>
    ...
    .pp-toc-title {
        font-family: var(--token-bea14fc0-25d6-4a5e-b6ed-f21e6a16c1e2, Inter), sans-serif;
        font-size: 28px;
        font-weight: 700;
        color: var(--token-0698ec6e-98d5-4dc5-82cd-980692a5f3e9, rgb(28, 24, 23));
        margin: 0 0 32px 0;
        line-height: 1.2;
    }
    .pp-toc-list {
    ...
    .pp-section-body p { margin: 0 0 12px 0; }
    .pp-section-body ul, .pp-section-body ol { margin: 0 0 12px 20px; padding: 0; }
    .pp-section-body li { margin-bottom: 6px; }
    .pp-section-body a { color: #c40023; text-decoration: underline; }
    .pp-section-body h3, .pp-section-body h4 { margin: 16px 0 8px; font-weight: 600; }
...
<div class="pp-content-wrap">
    <nav class="pp-toc">
        <h3 class="pp-toc-title">Table of Contents</h3>
        <ul class="pp-toc-list">
            @foreach($policySections as $idx => $sec)
                <li class="pp-toc-item">
                    <span class="pp-toc-dot"></span>
                    <a href="#pp-section-{{ $idx }}" class="pp-toc-link">
                        <span class="pp-toc-num">{{ str_pad($idx + 1, 2, '0', STR_PAD_LEFT) }}</span>
                        {{ $sec['title'] ?? 'Untitled' }}
                    </a>
                </li>
            @endforeach
    ...
    <div class="pp-sections">
        @foreach($policySections as $idx => $sec)
            <section id="pp-section-{{ $idx }}">
                <h2 class="pp-section-title">{{ ($idx + 1) }}. {{ $sec['title'] ?? 'Untitled' }}</h2>
                <div class="pp-section-body">{!! $sec['body'] ?? '' !!}</div>
            </section>
        @endforeach
    </div>
</div>
@endif
</main><div class="framer-126q734-container"><!--$--><div></div><!--/$--></div></div><div id="overlay"></div><div class="framer-staz4q"></div><div class="framer-1iqq7ze-container"><div class="ssr-variant hidden-16bwdqt hidden-me9n7f">@include('partials.framer._footer')
